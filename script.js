...
console.log('%c👋 Hello! Welcome to Pradesh Gwachha\'s Portfolio', 'color: #3b82f6; font-size: 16px; font-weight: bold;');
console.log('%cThanks for checking out the code! Feel free to reach out if you have any questions.', 'color: #64748